...
export default function subitem() {
  return (
    <div className="">
      <div>
        <div className="bg-white rounded-md p-2 sticky top-0">
          <ul className="flex gap-2">
            <li className="bg-[#EBE9F6] text-sm px-3 py-1.5 rounded-md">
              Employee List
            </li>
            <li className="bg-[#EBE9F6] text-sm px-3 py-1.5 rounded-md">
              Add Employee
        ...
        <p>
          ...
          Praesent nonummy mi in odio. Nunc interdum lacus sit amet orci.
          Vestibulum rutrum, mi nec elementum vehicula, eros quam gravida nisl,
          id fringilla neque ante vel mi. Morbi mollis tellus
        </p>
      </div>
    </div>
  );
