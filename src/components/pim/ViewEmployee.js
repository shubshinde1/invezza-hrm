...
export default function ViewEmployee() {
  ...
  const downloadPdf = () => {
    ...
    html2pdf()
      ...
      .set({
        margin: 1,
        filename: `Employee_${empid}.pdf`,
        html2canvas: { scale: 2 },
        jsPDF: jsPdfOptions,
      })
      .output("blob") // Get PDF as Blob
      .then((blob) => {
      ...
      <div>
        ...
        >
          <div className=" flex flex-col md:flex-row gap-2 md:gap-5">
            ...
            {/* <hr className="w-0.5 h-auto bg-gray-400" /> */}
        ...
        <div className="absolute right-5 bottom-5">
          <button
            onClick={downloadPdf}
            className="bg-[#5336FD] text-white p-2 rounded-md mt-4 z-50"
          >
