      ...
      <div className="">
        <div className="grid grid-cols-12 md:grid-rows-12 xl:h-screen gap-2 md:mb-28 mb-16">
          ...
          <motion.div
            ...
            className=" col-span-12 xl:col-span-3 pb-4 md:pb-4 md:-mt-4 md:row-span-2 xl:row-span-12 bg-white dark:bg-neutral-950 dark:text-white rounded-md 2xl:fixed 2xl:right-2 2xl:top-24"
          >
            <Calendar />
          </motion.div>
          <motion.div
