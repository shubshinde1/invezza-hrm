    ...
    <div className=" mx-auto pb-20 ">
      {client ? (
        <motion.div
          ...
          className="lg:flex gap-2 rounded-md bg-white dark:bg-neutral-900 dark:text-white p-2"
        >
              ...
              <div className="flex flex-row justify-between">
                ...
                <div className="flex gap-2">
                  <Tooltip title="View Contract" placement="top" arrow>
                    <div className="bg-sky-50 dark:bg-neutral-800 rounded-md cursor-pointer h-fit p-2 m-0">
                      <IoEye fontSize={20} />
                    </div>
                  </Tooltip>
          ...
          <div className="lg:w-2/3 rounded-md bg-sky-50 dark:bg-neutral-800 h-fit p-4 lg:m-2 lg:ml-0">
            <ul className="">
